...
''')
    ...
    if q1 == "// This is a comment" and q2 == "Indentation in Python is critical and is used to define the scope of loops, functions, and classes." and q3 == "Surround the comment with /* and */.":
        st.markdown('''
    ## Section 02: Variables and Data Types
